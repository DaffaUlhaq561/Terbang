...
=======
  ...
  const handleGoogleLogin = () => {
    setIsLoading(true);
    // Mock Google login - in production, integrate real OAuth
    setTimeout(() => {
      const mockUser = {
        name: "Demo User",
        email: "demo@smartvision.com",
      ...
      <Card className="w-full max-w-md p-8 space-y-6 bg-card/80 backdrop-blur-sm border-primary/20">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent">
            SmartVision Inventory
          </h1>
          <p className="text-muted-foreground">
            Sistem Pengelolaan Stok Berbasis AI Vision
          </p>
        </div>
        ...
        <Button
          onClick={handleGoogleLogin}
          disabled={isLoading}
          className="w-full h-12 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 gap-3"
        >
        ...
        <p className="text-xs text-center text-muted-foreground">
          Demo mode: Click to login with mock account
        </p>
      </Card>
>>>>>>> 1aa7b5416df4f8a05c7a02fc2f8f7f396b90e440
    </div>
